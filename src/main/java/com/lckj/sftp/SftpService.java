...
public class SftpService {
    ...
    public void createSftp() throws Exception {
        ...
        java.util.logging.FileHandler fh = new java.util.logging.FileHandler("D:\\Workplace\\JavaWorkSpace\\sftp-demo\\jsch.log");
        java.util.logging.SimpleFormatter formatter = new java.util.logging.SimpleFormatter();
        fh.setFormatter(formatter);
        logger.addHandler(fh);
        JSch.setLogger(new SftpLogger(logger));
//        log.info("Try to connect sftp[" + stfpConfig.getUsername() + "@" + stfpConfig.getHostname() + "]");
